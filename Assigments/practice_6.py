...
#         with open('assigment_6.txt', mode='a') as f:
#             f.write(data_to_store)
#             f.write('\n')
# #2) Add another option to your user interface: The user should be able to output the data stored in the file in the terminal.
#     elif user_input == '2':
#         with open('assigment_6.txt', mode='r') as f:
#             file_conten = f.readlines()
#             for line in file_conten:
#                 print(line)
#     elif user_input == 'q':
#         running = False
...
while running:
    ...
    if user_input == '1':
        ...
        with open('assigment_6.p', mode='wb') as f:
            #f.write(json.dumps(user_input_list))
            f.write(pickle.dumps(user_input_list))
#2) Add another option to your user interface: The user should be able to output the data stored in the file in the terminal.
    elif user_input == '2':
        with open('assigment_6.p', mode='rb') as f:
